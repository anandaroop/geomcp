...
description: Open vector basemap layers in QGIS for convenient visualization. Use this skill when the user wants "show that in qgis", "visualize those layers", etc.
---
